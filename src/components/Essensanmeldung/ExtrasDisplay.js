const ExtrasDisplay = ({ date }) => {
  ...
  const drawExtras = () => {
    ...
    while(meat > 0) {
      arr[index] = <rect x={2.7 * index + .010086} y=".001698" width="2.2535" height="4.3686" ry="1.1268" fill="url(#lgMeat)" opacity="1"/>
      meat--
      index++
    }
    ...
    while(vegi > 0) {
      arr[index] = <rect x={2.7 * index + .010086} y=".001698" width="2.2535" height="4.3686" ry="1.1268" fill="url(#lgVegi)" opacity="1"/>
      vegi--
      index++
    }
    ...
    while(index < 9){
      arr[index] = <rect x={2.7 * index + .010086} y=".001698" width="2.2535" height="4.3686" ry="1.1268" fill="url(#lgNone)" opacity="1"/>
      index++
    }
